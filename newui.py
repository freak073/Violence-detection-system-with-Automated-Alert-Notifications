...
def send_email(image_path):
    try:
        ...
        with smtplib.SMTP('smtp.gmail.com', 587) as server:
            ...
            messagebox.showinfo("Alert", "Violence detected! Email notification sent.")
    except Exception as e:
        print(f"Error sending email: {e}")
        messagebox.showerror("Error", "Failed to send email alert.")
...
def send_telegram_alert(image_path):
    try:
        ...
        messagebox.showinfo("Alert", "Violence detected! Telegram notification sent.")
    except Exception as e:
        print(f"Error sending Telegram alert: {e}")
        messagebox.showerror("Error", "Failed to send Telegram alert.")
